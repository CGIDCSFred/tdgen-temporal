        ...
        rows.append(
            {
                ...
                "bin_range": "".join(
                    [str(random.randint(4, 5))] + [str(random.randint(0, 9)) for _ in range(5)]
                ),
                "base_currency": "CAD",
        ...
        accounts.append(
            {
                ...
                "last_payment_date": random_past_date(
                    fake, years_back=1, as_of=run_date, not_before=open_date_parsed
                )
                if random.random() > 0.2
                else None,
                "last_payment_amount": round(random.uniform(25, 500), 2)
                if random.random() > 0.2
                else None,
                "open_date": open_date,
                "closed_date": random_past_date(
                    fake, years_back=1, as_of=run_date, not_before=open_date_parsed
                )
                if status == "CLOSED"
                else None,
                ...
                "last_monetary_date": random_past_date(
                    fake, years_back=1, as_of=run_date, not_before=open_date_parsed
                ),
        ...
        cards.append(
            {
                ...
                else ("BLOCKED" if status == "CHARGEOFF" else "CANCELLED"),
                "card_type": "primary",
                "chip_enabled": 1,
                ...
                "last_used_date": random_past_date(
                    fake, years_back=1, as_of=run_date, not_before=open_date_parsed
                ),
            }
        )
        ...
        temp_states.append(
            {
                ...
                "last_statement_date": random_past_date(
                    fake, years_back=1, as_of=run_date, not_before=open_date_parsed
                ),
